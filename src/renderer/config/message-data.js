window.APP_MESSAGE_DATA = {
  ...
  appMessages: {
    ...
    ARTICLE_UPDATE_AND_SAVE_SUCCESS: { text: "Article mis a jour et enregistre.", title: "Succes" },
    ARTICLE_ADD_SUCCESS: { text: "Article ajout\u00e9.", title: "Succes" },
    ARTICLE_ADD_WITH_REF_SUCCESS: { text: "Article ajout\u00e9 : R\u00c9F. {ref}", title: "Succes" },
