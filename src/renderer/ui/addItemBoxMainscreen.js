...
const renderArticlePanel = () => `
  ...
  <div class="add-actions">
    ...
    <button
      id="articleBulkDeleteOpenBtn"
      type="button"
      class="doc-type-action-btn"
      aria-label="Supprimer des articles"
      aria-haspopup="dialog"
      aria-controls="articleBulkDeleteModal"
    >
      <span class="doc-type-action-icon" aria-hidden="true">
      ...
      <span class="doc-type-action-label">Supprimer articles</span>
    </button>
  </div>
`;
