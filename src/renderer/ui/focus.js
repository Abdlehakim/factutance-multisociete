(function (w) {
  ...
  ["addRef","addProduct","addDesc","addUnit","addStockQty","addPurchasePrice","addPurchasePriceTtc","addPurchaseTva","addPurchaseDiscount","addPrice","addPriceTtc","addTva","addDiscount"].forEach((id)=>{
