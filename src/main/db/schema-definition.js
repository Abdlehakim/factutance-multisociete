...
const DOC_COLUMNS = [
  ...
  ["meta_pdf_be_remarks", "TEXT"],
  ["meta_pdf_be_remarks_size", "REAL"],
  ["meta_pdf_be_remarks_touched", "INTEGER"],
  ["meta_pdf_bs_remarks", "TEXT"],
  ["meta_pdf_bs_remarks_size", "REAL"],
  ["meta_pdf_bs_remarks_touched", "INTEGER"],
  ["meta_pdf_show_bs_issued_by", "INTEGER"],
  ["meta_pdf_show_bs_checked_by", "INTEGER"],
  ["meta_pdf_show_bs_validated_by", "INTEGER"],
  ["meta_pdf_bs_issued_by_name", "TEXT"],
  ["meta_pdf_bs_checked_by_name", "TEXT"],
  ["meta_pdf_bs_validated_by_name", "TEXT"],
  ["meta_taxes_enabled", "INTEGER"],
  ["meta_client_doc_taxes_mode", "TEXT"],
  ["meta_client_doc_taxes_client_path", "TEXT"],
  ["meta_client_doc_taxes_manual_override", "TEXT"],
  ["meta_client_doc_taxes_manual_override_client_path", "TEXT"],
  ...
  ["meta_be_reception_depot", "TEXT"],
  ["meta_be_reception_depot_id", "TEXT"],
  ["meta_be_reception_destination", "TEXT"],
  ["meta_be_reception_destination_id", "TEXT"],
  ["meta_be_reception_destination_ids_json", "TEXT"],
  ["meta_be_reception_destination_labels_json", "TEXT"],
  ["meta_be_reception_date", "TEXT"],
  ["meta_be_reception_time", "TEXT"],
  ["meta_be_reception_source_ref", "TEXT"],
  ["meta_be_reception_source_doc_type", "TEXT"],
  ["meta_be_reception_source_doc_id", "TEXT"],
  ["meta_be_reception_source_doc_key", "TEXT"],
  ["meta_be_reception_source_doc_number", "TEXT"],
  ["meta_be_reception_source_doc_label", "TEXT"],
  ["meta_be_reception_source_doc_path", "TEXT"],
  ...
  ["meta_bs_sortie_transporter", "TEXT"],
  ["meta_bs_sortie_driver_name", "TEXT"],
  ["meta_bs_sortie_vehicle_plate", "TEXT"],
  ["meta_bs_sortie_transport_mode", "TEXT"],
  ["meta_bs_sortie_exit_reason", "TEXT"],
...
const BASE_TABLE_DEFINITIONS = {
  ...
  clients: {
    columns: [
      ...
      ["client_type", "TEXT"],
      ["taxes", "TEXT DEFAULT 'non_exonoree'"],
      ["benefit", "TEXT"],
      ["account", "TEXT"],
