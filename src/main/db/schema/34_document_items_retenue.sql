CREATE TABLE IF NOT EXISTS "document_items_retenue" (
...
CREATE INDEX IF NOT EXISTS "idx_document_items_retenue_document_id" ON "document_items_retenue" ("document_id");
