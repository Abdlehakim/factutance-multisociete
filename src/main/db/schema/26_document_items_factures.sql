CREATE TABLE IF NOT EXISTS "document_items_factures" (
...
CREATE INDEX IF NOT EXISTS "idx_document_items_factures_document_id" ON "document_items_factures" ("document_id");
